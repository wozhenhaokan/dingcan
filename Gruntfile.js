...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        requirejs:{
            compile:{
                options:{
                    ...
                    mainConfigFile:'public/js/main.js',    //require的主文件路径
        ...
        imagemin: {
            dist: {
                ...
                files: [{
                    ...
                    cwd: 'public/img/', //基本路径(只针对src有效, 对dest无效)
        ...
        jshint : {
            ...
            files : ['Gruntfile.js', 'public/js/**/*.js', '!public/js/require.min.js', '!public/js/libs/*.js'] //检查哪些文件
        },
        ...
        copy: {
            main: {
                ...
                files: [
                    {
                        src: ['public/js/require.min.js'],
                        dest: 'build/js/require.min.js'
                    },
                    {
                        src: ['public/css/swiper.min.css'],
        ...
        watch : {
            scripts : {
                files : ['public/js/templates/*.html','public/js/**/*.js', 'public/css/*.css'],
    ...
    //2. 加载插件任务
    grunt.loadNpmTasks('grunt-contrib-jshint');  //eshint
